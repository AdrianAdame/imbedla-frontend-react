...
import PlantCardGeneric from "./components/PlantCardGeneric";
...
const Plants = () => {
    ...
    //         const url = "https://house-plants.p.rapidapi.com/all";
    //         const options = {
    //             method: "GET",
    //             headers: {
    //                 "X-RapidAPI-Key":
    //                     "1693258d30mshe95f911abac6914p170bd1jsnf9f19f7d4cd4",
    ...
    //             setAllPlants(JSON.parse(result))
    //         } catch (error) {
    //             console.error(error);
    //         }
    //     };
    ...
    return (
        <main className="h-full flex flex-col flex-wrap lg:flex-nowrap justify-around">
            <div className="flex justify-center p-2 w-full h-fit">
                <div>
                    ...
                    <Typography
                        ...
                        color={currentMode === "dark" ? "white" : null}
                    >
                        Here you can view all the plants we currently support,
                        we will add more soon!
                    </Typography>
                </div>
            </div>
            <div className="grid gap-4 grid-cols-12 auto-rows-[10rem] py-4">
                {isTablet || isMobile ? (
                    <>
                    {allPlants.map((plant, index) => (
                        <div className="flex flex-col justify-between py-5 px-4 flex-[1_1_100%] col-span-12 row-span-1 rounded-lg " key={index}>
                            <PlantCardGeneric plant={plant} />
                        </div>
                    ))}
                    <IconButton className={`!fixed bottom-8 right-8 rounded-full`} size="lg" color="amber" ripple={true} onClick={handleGoUp}>
                        <FontAwesomeIcon icon={faAngleDoubleUp} className="h-6 w-6"/>
                    </IconButton>
                    </>
                ) : (
